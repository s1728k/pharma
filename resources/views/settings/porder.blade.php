...
<div class="col-md-2">
  <div style="border:1px solid grey;padding: 10px;margin: 10px;display: inline-block">
    Puchase Order# prefix 
    <div style="font-size: 12px; width:200px">
      <input type="text" style="width:100%;" name="porder_prefix" value="{{$setting->porder_prefix}}" class="cs">
    </div>
    Starting porder number 
    <div style="font-size: 12px; width:200px">
      <input type="number" style="width:100%;" name="starting_porder_no" value="{{$setting->starting_porder_no}}" class="cs">
    </div>
  </div>
  <div style="border:1px solid grey;padding: 10px;margin: 10px;display: inline-block">
    Customize Puchase Order text lables
    <div style="width:200px; height: 45vh; overflow-y: auto; background: white">
      <table class="table table-bordered table-custom">
          <tr><td style="padding: 0px;"><input type="text"  class="rl" name="rl50" value="{{$rlables[49]->custom}}"></td></tr>
          <tr><td style="padding: 0px;"><input type="text" class="rl" name="rl51" value="{{$rlables[50]->custom}}"></td></tr>
          <tr><td style="padding: 0px;"><input type="text" class="rl" name="rl52" value="{{$rlables[51]->custom}}"></td></tr>
          <tr><td style="padding: 0px;"><input type="text" class="rl" name="rl53" value="{{$rlables[52]->custom}}"></td></tr>
          <tr><td style="padding: 0px;"><input type="text" class="rl" name="rl54" value="{{$rlables[53]->custom}}"></td></tr>
          <tr><td style="padding: 0px;"><input type="text" class="rl" name="rl55" value="{{$rlables[54]->custom}}"></td></tr>
          <tr><td style="padding: 0px;"><input type="text" class="rl" name="rl56" value="{{$rlables[55]->custom}}"></td></tr>
      </table>
    </div>
...
<div class="col-md-9">
  <div id="section-to-print" style="border: 1px solid black; background: lavender; padding: 10px;margin: 10px; height: 50vh; overflow-y:scroll; width: 100% ">
    <div class="row" style="background: white; border: 1px solid black; width:1080px; height:1619px;margin:0 auto;position: relative;">
      ...
      <div class="col-md-12" style="display: inline-block;">
        <table class="table table-bordered" style="border-collapse: collapse;">
          ...
          <tbody>
            ...
            <tr>
              <td colspan="2" style="visibility: hidden;"></td>
              <td colspan="2">Puchase Order total</td>
              <td>₹ 238.00</td>
            </tr>
            <tr>
              <td colspan="2" style="visibility: hidden;"></td>
      ...
      <div class="col-md-12" style="position: absolute;bottom: 30px;">
        ...
        <p>Puchase Orders are payable on receipt unless other terms, negotiated and noted on the porder. By accepting delivery of goods, Buyer agrees to pay the porderd cost for those goods, and agrees to be bound to these contract terms. No acceptance may vary these terms unless specifically agreed in writing by Seller.</p>
      </div>
  ...
  <div style="border:1px solid grey;padding: 10px;margin: 10px;display: inline-block; width: 100%">
    Predefined terms and conditions text for porders 
    <div style="font-size: 12px; width:100%">
      <textarea rows="4" style="width:100%;" name="porder_tctext" class="cs">{{$setting->porder_tctext}}</textarea>
    </div>
  </div>
</div>
</div>