          	...
          	<table style="width: 100%"><thead><tr><td>
						      ...
						      <div style="float: left">
						        <div class="row">
						          <div class="col-md-12">
						          	<pre><table>
						          				<tr>
						          					<td style="width: 100px;text-align: left;">{{$l[33]}}</td>
						          					<td style="width: 100px;text-align: left;">{{$d->order_no}}</td>
						          				</tr>
						          				<tr>
						          					<td style="width: 100px;text-align: left;">{{$l[34]}}</td>
						          					<td style="width: 100px;text-align: left;">{{$d->order_date}}</td>
						          				</tr>
						          				<tr>
						          					<td style="width: 100px;text-align: left;">{{$l[35]}}</td>
	            ...
	            <div class="row">
				        <div class="col-md-12">
				          ...
				          <pre><u>{{$l[36]}}</u><br>{{$d->estimate_to}}<br>{{$d->iaddress}}</pre></div>
	            	...
	            	<div class="col-md-12">
						      <table class="table table-bordered" style="font-family: monospace;font-size: 12px;">
						        ...
						        <tbody>
						          ...
						          <tr>
						            <td colspan="2" style="visibility: hidden;"></td>
						            <td colspan="2" style="padding: 0px">{{$l[37]}}</td>
						            <td style="padding: 0px">{{$s->currency_sign}} {{number_format($d->estimate_total,2)}}</td>
						          </tr>
						          <tr>
						            <td colspan="2" style="visibility: hidden;"></td>
