          	...
          	<table style="width: 100%"><thead><tr><td>
						      ...
						      <div style="float: left">
						        <div class="row">
						          <div class="col-md-12">
						          	<pre><table>
						          				<tr>
						          					<td style="width: 100px;text-align: left;">{{$l[27]}}</td>
						          					<td style="width: 100px;text-align: left;">{{$d->order_no}}</td>
						          				</tr>
						          				<tr>
						          					<td style="width: 100px;text-align: left;">{{$l[28]}}</td>
						          					<td style="width: 100px;text-align: left;">{{$d->order_date}}</td>
						          				</tr>
						          				<tr>
						          					<td style="width: 100px;text-align: left;">{{$l[29]}}</td>
	            ...
	            <div class="row">
				        <div class="col-md-12">
				          ...
				          <pre><u>{{$l[30]}}</u><br>{{$d->order_to}}<br>{{$d->iaddress}}</pre></div>
	            	...
	            	<div class="col-md-12">
						      <table class="table table-bordered" style="font-family: monospace;font-size: 12px;">
						        ...
						        <tbody>
						          ...
						          <tr>
						            <td colspan="2" style="visibility: hidden;"></td>
						            <td colspan="2" style="padding: 0px">{{$l[31]}}</td>
						            <td style="padding: 0px">{{$s->currency_sign}} {{number_format($d->order_total,2)}}</td>
						          </tr>
						          <tr>
						            <td colspan="2" style="visibility: hidden;"></td>
