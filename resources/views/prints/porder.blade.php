          	...
          	<table style="width: 100%"><thead><tr><td>
						      ...
						      <div style="float: left">
						        <div class="row">
						          <div class="col-md-12">
						          	<pre><table>
						          				<tr>
						          					<td style="width: 100px;text-align: left;">{{$l[50]}}</td>
						          					<td style="width: 100px;text-align: left;">{{$d->porder_no}}</td>
						          				</tr>
						          				<tr>
						          					<td style="width: 100px;text-align: left;">{{$l[51]}}</td>
						          					<td style="width: 100px;text-align: left;">{{$d->porder_date}}</td>
						          				</tr>
						          				<tr>
						          					<td style="width: 100px;text-align: left;">{{$l[52]}}</td>
	            ...
	            <div class="row">
				        <div class="col-md-12">
				          ...
				          <pre><u>{{$l[53]}}</u><br>{{$d->vendor}}<br>{{$d->iaddress}}</pre></div>
				          <div style="float: right;margin-right: 100px;">
				          <pre><u>{{$l[54]}}</u><br>{{$d->delivery_to}}<br>{{$d->saddress}}</pre></div>
				        </div>
	            </div>
	            <div class="row">
	            	<div class="col-md-12">
						      <table class="table table-bordered" style="font-family: monospace;font-size: 12px;">
						        <thead>
						          <tr>
						            ...
						            <th style="padding: 0px;">{{$l[12]}}</th>
						            <th style="padding: 0px;">{{$l[13]}}</th>
						          </tr>
						        </thead>
						        <tbody>
						          ...
						          <tr>
						            <td colspan="2" style="visibility: hidden;"></td>
						            <td colspan="2" style="padding: 0px">{{$l[55]}}</td>
						            <td style="padding: 0px">{{$s->currency_sign}} {{number_format($d->porder_total,2)}}</td>
						          </tr>
						        </tbody>
						      </table>
						    </div>
	            ...
	            <div class="row">
	            	<div class="col-md-12">
	            		<pre style="text-align: left; background: white; border:none">Notes:-<br>{{$d->comments}}</pre>
	            	</div>
	            </div>
            </td></tr></tbody><tfoot><tr><td><div class="footer-space">&nbsp;</div>
	            <div class="row">
	            	<div class="col-md-12" style="font-family: monospace;font-size: 12px">
						      <pre style="text-align: left; background: white; border:none"><p style="text-align: center; border-bottom: 1px solid black;">{{$l[22]}}</p>{{$d->terms}}</pre>
						    </div>
	            </div>
