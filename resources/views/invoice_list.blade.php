  ...
  <div class="row menu-bar">
    <div class="col-md-10">
      <div class="btn-group btn-group-custom">
        <button class="menu_button" onclick="invoiceView()"><i class="fa fa-plus"></i><br> Create New<br>Invoice</button>
        <button class="menu_button" onclick="viewInvoice()"><i class="fa fa-pencil-square-o"></i><br> View/Edit<br>Invoice</button>
        <button class="menu_button" onclick="deleteInvoices()"><i class="fa fa-times"></i><br> Delete<br>Selected</button>
...
<script>
  function invoiceView(){
    $.post("{{route("invoice.new")}}",{"_token":"{{csrf_token()}}"},function(id, status){
      if(status=="success"){
